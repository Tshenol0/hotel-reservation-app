<%-- 
    Document   : bookings
    Created on : Jun 26, 2024, 2:28:47 PM
    Author     : Train
--%>
                                ...
                                <a href="BookingsServlet?bookings=<%= booking.getId() %>" class="room">
                                    ...
                                    <div class="state-change">
                                        <% if (booking.getStatus().equals("pending") || booking.getStatus().equals("accepted")) { %>
                                            <a class="selection" href="AllAndLateServlet?bookings=cancel&booking=<%=booking.getId() %>">Cancel</a>
                                            <a class="checkout" href="EditServlet?bookings=edit&booking=<%=booking.getId()%>&user=<%=booking.getUser()%>">edit</a>
