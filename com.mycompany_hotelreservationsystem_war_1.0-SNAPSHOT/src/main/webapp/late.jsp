<%-- 
    Document   : late
    Created on : Jun 26, 2024, 2:01:30 PM
    Author     : Train
--%>
...
<%
    List<Booking> late = (List<Booking>)request.getAttribute("latebookings");
    User user = (User)request.getSession(false).getAttribute("user");
%>    
<%-- 
    Document   : track
    Created on : 23 Jun 2024, 10:16:27 PM
    Author     : User
--%>
<%@page import="com.mycompany.hotelreservationsystem.Booking.BookingModel.Booking"%>
<%@page import="java.util.List"%>
<%
    List<Booking> bookings = (List<Booking>)request.getAttribute("history");
%>
        ...
        <main>
            ...
            <ul class="room-list scrollable-content">
                    ...
                    <% if (late != null && !late.isEmpty()) { %>
                            ...
                            <li class="item">
                                <a href="BookingsServlet?bookings=<%= booking.getId() %>" class="room">
                                    ...
                                    <div class="state-change">
                                            <a class="selection" href="AllAndLateServlet?bookings=cancel late&booking=<%= booking.getId() %>">Cancel</a>
                                    </div>                                    
                        ...
                        <% } %>
                    <% } else { %>
                        <div class="no-bookings">All bookings up to date.</div>
                    <% } %>
            </ul>                 
            </div>
