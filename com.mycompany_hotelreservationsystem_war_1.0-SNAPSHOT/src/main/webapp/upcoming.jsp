<%-- 
    Document   : upcoming
    Created on : 23 Jun 2024, 10:19:02 PM
    Author     : User
--%>
...
<%
    List<Booking> bookings = (List<Booking>)request.getAttribute("upcoming");
                                ...
                                <a href="BookingsServlet?bookings=<%= booking.getId() %>" class="room">
                                    ...
                                    <div class="state-change">
                                        <% if (booking.getStatus().equals("pending")) { %>
                                            ...
                                            <a class="checkout" href="BookingsServlet?bookings=checkout&booking=<%= booking.getId() %>">Checkout</a>
